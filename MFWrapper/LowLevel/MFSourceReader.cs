...
namespace MFWrapper
{
    public class MFSourceReader : Unknown
    {
        ...
        public void SetCurrentPosition(in Guid guidTimeFormat, in PropVariant varPosition)
        {
            Marshal.ThrowExceptionForHR(NativeMFSourceReaderSetCurrentPosition(_instance, in guidTimeFormat, in varPosition));
        }
        ...
        {
            Marshal.ThrowExceptionForHR(NativeMFSourceReaderGetServiceForStream(_instance, dwStreamIndex, in guidService, in riid, out ppvObject));
        }

        public void GetPresentationAttribute(IntPtr pSourceReader, uint dwStreamIndex, in Guid guidAttribute, out PropVariant pvarAttribute)
        {
            Marshal.ThrowExceptionForHR(NativeMFSourceReaderGetPresentationAttribute(_instance, dwStreamIndex, in guidAttribute, out pvarAttribute));
        }
        ...
        private static extern int NativeMFSourceReaderSetCurrentPosition(IntPtr pSourceReader, in Guid guidTimeFormat, in PropVariant varPosition);
        ...
        private static extern int NativeMFSourceReaderGetServiceForStream(IntPtr pSourceReader, uint dwStreamIndex, in Guid guidService, in Guid riid, out IntPtr ppvObject);
        ...
        private static extern int NativeMFSourceReaderGetPresentationAttribute(IntPtr pSourceReader, uint dwStreamIndex, in Guid guidAttribute, out PropVariant pvarAttribute);
        #endregion
    }
}
